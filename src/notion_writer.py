...
def publish_report(page_id: str, report_path: Path, username: str = None) -> str:
    ...
    username : str, optional
        Username of the person who generated the report for attribution.
    ...
    for blk in children.get("results", []):
        if blk.get("type") == "child_page":
            ...
            # Match either the old format or new format with username
            if title == "AI Deep Research Report" or title == page_title:
