...
import sys
from pathlib import Path
# Add root directory to path to access main web_research module
...
async def _deep_research_runner(
    ...
    *,
    ...
    # ------------------------------------------------------------------
    # 2. Kick-off deep research using OpenRouter
    # ------------------------------------------------------------------
    # Set OpenRouter configuration for the web_research module
    os.environ["OPENAI_API_ENDPOINT"] = os.getenv("OPENROUTER_BASE_URL", "https://openrouter.ai/api/v1")
    os.environ["OPENAI_MODEL"] = os.getenv("OPENROUTER_MODEL", "qwen/qwen-2.5-72b-instruct")
